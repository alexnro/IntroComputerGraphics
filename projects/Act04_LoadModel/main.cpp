...
void render(const Model& object, const Shader& normal_shader, const Texture& t_albedo, const Texture& t_specular, const Texture& t_normal) {
...
int main(int, char* []) {
	...
	const Texture t_albedo(ASSETS_PATH "models/Freighter/Freighter_C.jpg", Texture::Format::RGB);
	const Texture t_specular(ASSETS_PATH "models/Freighter/Freighter_S.jpg", Texture::Format::RGB);
	const Texture t_normal(ASSETS_PATH "models/Freighter/Freighter_N.jpg", Texture::Format::RGB);
	...
	while (window->isAlive()) {
		...
		render(object, normal_shader, t_albedo, t_specular, t_normal);
		window->handleFrame();
	}
